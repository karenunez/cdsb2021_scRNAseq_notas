---
title: "Identificacion de genes marcadores"
author: "Karen Nuñez"
date: "8/12/2021"
...
plotExpression(sce.pbmc,
    features = rownames(sce.pbmc)[1990],
...
- Comparaciones involucrando clúster 16
...
##genes diferencialme expresados en todas las comparaciones pareadas
...
##heatmap
best.set <- interesting.up3[interesting.up3$Top <= 5, ]
logFCs <- as.matrix(best.set[, -(1:3)])
colnames(logFCs) <- sub("logFC.", "", colnames(logFCs))
pheatmap(logFCs, breaks = seq(-5, 5, length.out = 101))
```
